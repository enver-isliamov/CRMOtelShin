...
*   [Удалить эту функцию]**Заявка на выдачу:** Кнопка "Забрать шины" запрашивает дату/время текстом и уведомляет админа.
*   [Удалить эту функцию] **Калькулятор продления:** Интерактивный выбор срока (1, 6, 12 мес) и опции "с дисками", расчет итоговой суммы текстом.
